...
export const MOCK_FIXTURES: Fixture[] = [
  ...
  // Premier League Finished Fixtures (for dynamic form derivation)
  {
    id: 'pl-ars-bha-fin',
    league: 'PL',
    home_team_id: 'arsenal',
    away_team_id: 'brighton',
    match_time: '2026-09-13T16:30:00Z',
    status: 'FINISHED',
    score_home: 1,
    score_away: 2,
    homeTeam: MOCK_TEAMS['arsenal'],
    awayTeam: MOCK_TEAMS['brighton'],
  },
  {
    id: 'pl-ars-wol-fin',
    league: 'PL',
    home_team_id: 'arsenal',
    away_team_id: 'wolves',
    match_time: '2026-09-06T14:00:00Z',
    status: 'FINISHED',
    score_home: 2,
    score_away: 0,
    homeTeam: MOCK_TEAMS['arsenal'],
  ...
  },
  {
    ...
    match_time: '2026-08-30T16:30:00Z',
    status: 'FINISHED',
    score_home: 0,
    score_away: 2,
    homeTeam: MOCK_TEAMS['aston-villa'],
  ...
  },
  {
    ...
    home_team_id: 'arsenal',
    away_team_id: 'wolves',
    match_time: '2026-08-23T14:00:00Z',
    status: 'FINISHED',
    score_home: 3,
    score_away: 0,
    homeTeam: MOCK_TEAMS['arsenal'],
  ...
  },
  {
    ...
    away_team_id: 'arsenal',
    match_time: '2026-08-16T16:30:00Z',
    status: 'FINISHED',
    score_home: 0,
    score_away: 1,
    homeTeam: MOCK_TEAMS['chelsea'],
    awayTeam: MOCK_TEAMS['arsenal'],
  },
  {
    id: 'bl-dor-stu',
